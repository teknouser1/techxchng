	...
	<div class="container">
		<div class="row mb-5">
            <div class="col-12 text-center">
                <h3 class="mb-3">Contacted Buyers (40) </h3>
            </div>
        </div>
			<table class="table table-bordered">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td>Test Patel</td>
			      <td>test@test.com</td>
			      <td>Corporate Buyer</td>
			      <td><a href="{{ route('view-buyer') }}">View Buyer</a></td>
			    </tr>
			    <tr>
			      <th scope="row">2</th>
			      <td>Test1 Patel</td>
			      <td>test1@test.com</td>
			      <td>LinkedIn Buyer</td>
			      <td><a href="{{ route('view-buyer') }}">View Buyer</a></td>
			    </tr>
			    <tr>
			      <th scope="row">3</th>
			 ...
			 <div class="row mb-5">
                <div class="col-12 text-center">
                    ...
                    <h3 class="mb-3">List Of  Technology Uploaded  (40) </h3>
                </div>
            </div>
			<table class="table table-bordered">
			  <thead>
