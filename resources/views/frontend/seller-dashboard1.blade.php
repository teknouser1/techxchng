                ...
                <div class="container">
                        <div class="row mb-5">
                            <div class="col-12 text-center">
                                <h2 class="section-title mb-3">Contacted Buyers (40) </h2>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="h-entry">
                                <a href="single.html"><img src="{{ URL::asset('/frontend/images/img_1.jpg') }}" alt="Image" class="img-fluid"></a>
                                <h2 class="font-size-regular"><a href="single.html">Technology1</a></h2>
                                ...
                                <p><a href="single.html">know More...</a></p>
                            </div> 
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                            <div class="h-entry">
                                <a href="single.html"><img src="{{ URL::asset('/frontend/images/img_2.jpg') }}" alt="Image" class="img-fluid"></a>
                                <h2 class="font-size-regular"><a href="single.html">Technology1</a></h2>
                    ...
                    <div class="container">
                            <div class="row mb-5">
                                    <div class="col-12 text-center">
                                        ...
                                        <h2 class="section-title mb-3">List Of  Technology Uploaded  (40) </h2>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                                <div class="row mb-5">
                                        <div class="col-12 text-center">
                                                ...
                                                <h2 class="section-title mb-3">Technology Reported (40) </h2>
                                            </div>
                                    </div>
